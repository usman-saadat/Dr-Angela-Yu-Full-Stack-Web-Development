...
app.get("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id); // req.params.id returns string "2", converting it to number using parseInt.
...
app.post("/jokes", (req, res) => {
  ...
  jokes.push(newJoke);
  console.log(jokes.slice(-1)); // to see last/newly added joke
  res.json(newJoke);
});
